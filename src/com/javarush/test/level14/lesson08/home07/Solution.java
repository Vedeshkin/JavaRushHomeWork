...
public class Solution
{
    ...
    {
        for (Apartament appartament : apartaments)
        {
            if(appartament instanceof Apt1Room) ((Apt1Room) appartament).clean1Room();
            if(appartament instanceof Apt2Room)  ((Apt2Room) appartament).clean2Rooms();
            if(appartament instanceof Apt3Room) ((Apt3Room) appartament).clean3Rooms();
        }
    }
